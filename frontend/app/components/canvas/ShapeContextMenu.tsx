...
export function ShapeContextMenu() {
	...
	return (
		<>
			<div
				ref={menuRef}
				className="fixed z-[var(--z-popover,60)] min-w-[180px] py-1 rounded-xl card-forge"
			...
			{isEditing && (
				...
				>
					<div
						className="card-forge p-4 w-80 space-y-3"
						onClick={(e) => e.stopPropagation()}
					>
						<h3 className="font-heading font-bold text-sm m-0">修改意见</h3>
						<textarea
							className="input-forge w-full text-sm p-2 resize-none"
							rows={3}
							placeholder="请描述修改方向"
							value={editContent}
							autoFocus
						...
						<div className="flex justify-end gap-2">
							...
							<button
								type="button"
								className="btn btn-sm btn-forge btn-primary"
