...
function CharacterCard({ character }: { character: ReviewedCharacter }) {
	...
	return (
		<article className="group overflow-hidden card-forge">
			...
			<div className="space-y-1.5 p-3">
				...
				{isEditing ? (
					<div className="space-y-1.5 pt-1">
						<textarea
							className="input-forge w-full text-xs p-2 resize-none"
							rows={2}
							placeholder="修改意见"
							value={feedbackText}
							onPointerDown={stopCanvasDrag}
						...
						<div className="flex gap-1">
							<button
								type="button"
								className="btn btn-xs btn-forge btn-primary"
								onPointerDown={stopCanvasDrag}
			...
			<div className="space-y-1.5 p-3">
				...
				{isEditing ? (
					<div className="space-y-1.5 pt-1">
						<input
							type="text"
							className="input-forge w-full text-xs p-2"
							placeholder="动作"
							value={editAction}
							onPointerDown={stopCanvasDrag}
								...
								<Fragment key={section}>
									{showFlowConnector && (
										...
										>
											...
											<span className="absolute rounded-full border-2 border-base-content/20 bg-base-100 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-base-content/60 shadow-sm">
												...
												<div className="space-y-3">
													...
													<div className="flex justify-end">
														<a
															...
															download
															className="btn btn-sm btn-forge gap-1 text-xs"
															onPointerDown={stopCanvasDrag}
														>
