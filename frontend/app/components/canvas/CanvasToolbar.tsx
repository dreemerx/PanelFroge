...
export const CanvasToolbar = track(function CanvasToolbar({
  ...
  return (
    <>
    <div
      className={`absolute bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1 p-1.5 rounded-xl bg-base-200/90 border border-base-300 shadow-forge text-base-content backdrop-blur-sm ${className || ""}`}
    >
      {/* 选择工具 */}
