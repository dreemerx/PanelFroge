...
3. Watch progress: `watch -n2 "docker exec panelforge-postgres-1 psql -U panelforge -d panelforge -c \"SELECT progress, current_agent FROM agentrun ORDER BY id DESC LIMIT 1\""`
